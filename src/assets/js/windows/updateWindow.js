        ...
        const en = JSON.parse(`[
          {
              ...
              "Principium_autem4": "Watch the 14 short films and one feature film programmed directly in Minecraft via an in-game viewing system and play the associated mini-games with your friends!",
              "JOUER": "PLAY",
        ...
        const es = JSON.parse(`[
          {
              ...
              "Principium_autem4": "Vea los 14 cortometrajes y un largometraje programados directamente en Minecraft gracias a un sistema de visionado dentro del juego y juegue a los minijuegos asociados con sus amigos.",
              "JOUER": "JUGAR",
        ...
        const fr = JSON.parse(`[
          {
              ...
              "Principium_autem4": "Regardez les 14 courts métrages et un long métrage programmés directement dans Minecraft via un système de visionnage en jeux et jouez au mini-jeux associés avec vos amis !",
              "JOUER": "JOUER",
